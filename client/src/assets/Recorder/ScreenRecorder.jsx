  ...
  return (
    <div className={styles.main_container}>
      ...
      <p>
        <label>
          Enable microphone
          <input className={styles.checkbox_btn}
            type="checkbox"
            checked={audio}
      ...
      <section className={styles.section_rec}>
        {status !== "recording" && (
          <div className={styles.button_container}>
            <button
              type="button" className={styles.record_button}
              onClick={async () => {
                // await getMediaStream();
                startRecording();
              }}
            ...
            <button
              type="button" className={styles.share_button}
              onClick={async () => {
                await getMediaStream();
              }}
            >
        ...
        {status === "recording" && (
          <button className={styles.pause_button} type="button" onClick={pauseRecording}>
            Pause recording
          </button>
        )}
        {status === "paused" && (
          <button className={styles.resume_button} type="button" onClick={resumeRecording}>
            Resume recording
          </button>
        )}
        {status === "recording" && (
          <button className={styles.stop_recording_button} type="button" onClick={stopRecording}>
            Stop recording
          </button>
        )}
      </section>
